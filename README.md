...
* **Patch-Based Performance**: The localized patch-based (exemplar) baseline is computationally expensive (averaging ~1.16s per image) and records lower global PSNR/SSIM. This is due to localized structural differences and typical patch misalignment on thin scratches, illustrating that patch search is sub-optimal compared to edge-aware propagation.
